...
-- Clause-reduction budget gate soundness for sequential ay SAT-COMP runs.
-- Aggressive learned-clause reduction changes search cost, not public
-- SAT/UNSAT semantics. Public results are admitted only through checker/replay.
...
def AySequentialReductionBudget (budgetToken : Prop) :=
  budgetToken

def AyBaselineReductionBudget (budgetToken : Prop) :=
  AySequentialReductionBudget budgetToken

def AyAggressiveReductionBudget (budgetToken : Prop) :=
  AySequentialReductionBudget budgetToken

def AySelectedCompetitionPolicy (policyToken : Prop) :=
  AySequentialReductionBudget policyToken
...
def AyReductionBudgetDiagnostic
...
def AyReductionBudgetGateAccepted
...
def AyReductionBudgetGateRejected
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    (rejected : Prop) :=
  AyConj rejected (AyReductionBudgetDiagnostic timeout noResult mismatch)

def AyReductionBudgetGate
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop)
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    (rejected : Prop) :=
  AyDisj
    (AyReductionBudgetGateAccepted
      candidateFaster retentionOk checkerAccepted replayAccepted
      candidateAccepted)
    (AyReductionBudgetGateRejected timeout noResult mismatch rejected)
...
theorem ay_reduction_budget_gate_candidate_faster
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyReductionBudgetGateAccepted
...
theorem ay_reduction_budget_gate_checker_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyReductionBudgetGateAccepted
...
theorem ay_reduction_budget_gate_replay_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyReductionBudgetGateAccepted
...
theorem ay_reduction_budget_gate_retention_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyReductionBudgetGateAccepted
...
theorem ay_reduction_budget_gate_run_replay
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyReductionBudgetGateAccepted
...
theorem ay_aggressive_reduction_budget_public_result_sound
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
  ...
  exact ay_manifest_public_soundness
    ...
    (ay_reduction_budget_gate_run_replay
      candidateFaster retentionOk checkerAccepted replayAccepted
      candidateAccepted gate)

theorem ay_reduction_budget_is_search_only
...
theorem ay_reduction_budget_diagnostic_no_claim
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    (rejected : Prop) :
    AyReductionBudgetGateRejected timeout noResult mismatch rejected ->
    AyConj
      (AyReductionBudgetDiagnostic timeout noResult mismatch)
      (AyReductionBudgetGateRejected timeout noResult mismatch rejected) := by
  intro rejection
  exact ay_conj_intro
    (AyReductionBudgetDiagnostic timeout noResult mismatch)
    (AyReductionBudgetGateRejected timeout noResult mismatch rejected)
...
theorem ay_reduction_budget_fallback_preserves_baseline
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
...
theorem ay_reduction_budget_rejection_cannot_bless_candidate
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
...
theorem ay_safe_reduction_budget_sequential_deployment_accept
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
  ...
  intro accepted_gate
  intro candidate_manifest
  exact ay_aggressive_reduction_budget_public_result_sound
    originalFormula visibleFormula visibleModel originalModel finalClause
    candidateFaster retentionOk checkerAccepted replayAccepted candidateAccepted
    accepted_gate candidate_manifest

theorem ay_safe_reduction_budget_sequential_deployment_fallback
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
    (baselineAccepted : Prop)
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    ...
    AyConj
      (AyPublicSoundnessTheorem originalFormula originalModel)
      (AyReductionBudgetDiagnostic timeout noResult mismatch) := by
  intro rejection
  intro baseline_manifest
  intro baseline_accepted
  exact ay_conj_intro
    (AyPublicSoundnessTheorem originalFormula originalModel)
    (AyReductionBudgetDiagnostic timeout noResult mismatch)
    (ay_reduction_budget_fallback_preserves_baseline
      originalFormula visibleFormula visibleModel originalModel finalClause
