...
impl DomainSeparator {
    fn as_bytes(self) -> &'static [u8] {
        match self {
            DomainSeparator::FoldingChallenge => b"clean-fold:folding-challenge",
            DomainSeparator::WitnessCommitment => b"clean-fold:witness-commitment",
            DomainSeparator::CrossTermCommitment => b"clean-fold:cross-term-commitment",
            DomainSeparator::PublicInput => b"clean-fold:public-input",
        }
    }
}
...
impl Transcript {
    ...
    pub fn new() -> Self {
        ...
        hasher.update(b"clean-fold-transcript-v1");
        Self { hasher }
    }
