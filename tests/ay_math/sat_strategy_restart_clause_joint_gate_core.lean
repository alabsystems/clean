...
-- Joint restart-policy and clause-reduction gate soundness for sequential
-- ay SAT-COMP runs. The candidate combines LBD restarts with aggressive
-- learned-clause reduction. Adoption is public-result sound only with
-- checker/replay evidence and justified retained learned clauses.
...
def AySequentialJointPolicy (policyToken : Prop) :=
  policyToken

def AyBaselinePolicy (policyToken : Prop) :=
  AySequentialJointPolicy policyToken

def AyJointLbdClausePolicy (policyToken : Prop) :=
  AySequentialJointPolicy policyToken
...
def AyJointGateRejected
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    (rejected : Prop) :=
  AyConj rejected (AyJointPolicyDiagnostic timeout noResult mismatch)
...
def AyJointGate
  ...
  AyDisj
    (AyJointGateAccepted
      ...
      candidateAccepted)
    (AyJointGateRejected timeout noResult mismatch rejected)
...
theorem ay_joint_gate_candidate_faster
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyJointGateAccepted
...
theorem ay_joint_gate_checker_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyJointGateAccepted
...
theorem ay_joint_gate_replay_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyJointGateAccepted
...
theorem ay_joint_gate_retention_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyJointGateAccepted
...
theorem ay_joint_gate_run_replay
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyJointGateAccepted
...
theorem ay_joint_restart_clause_public_result_sound
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
  ...
  exact ay_manifest_public_soundness
    ...
    (ay_joint_gate_run_replay
      candidateFaster retentionOk checkerAccepted replayAccepted
      candidateAccepted gate)

theorem ay_joint_policy_is_search_only
...
theorem ay_joint_gate_diagnostic_no_claim
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    (rejected : Prop) :
    AyJointGateRejected timeout noResult mismatch rejected ->
    AyConj
      (AyJointPolicyDiagnostic timeout noResult mismatch)
      (AyJointGateRejected timeout noResult mismatch rejected) := by
  intro rejection
  exact ay_conj_intro
    (AyJointPolicyDiagnostic timeout noResult mismatch)
    (AyJointGateRejected timeout noResult mismatch rejected)
...
theorem ay_joint_gate_fallback_preserves_baseline
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
...
theorem ay_joint_gate_rejection_cannot_bless_candidate
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
...
theorem ay_safe_joint_policy_sequential_deployment_accept
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
  ...
  intro accepted_gate
  intro candidate_manifest
  exact ay_joint_restart_clause_public_result_sound
    originalFormula visibleFormula visibleModel originalModel finalClause
    candidateFaster retentionOk checkerAccepted replayAccepted candidateAccepted
    accepted_gate candidate_manifest

theorem ay_safe_joint_policy_sequential_deployment_fallback
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
    (baselineAccepted : Prop)
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    ...
    AyConj
      (AyPublicSoundnessTheorem originalFormula originalModel)
      (AyJointPolicyDiagnostic timeout noResult mismatch) := by
  intro rejection
  intro baseline_manifest
  intro baseline_accepted
  exact ay_conj_intro
    (AyPublicSoundnessTheorem originalFormula originalModel)
    (AyJointPolicyDiagnostic timeout noResult mismatch)
    (ay_joint_gate_fallback_preserves_baseline
      originalFormula visibleFormula visibleModel originalModel finalClause
