...
Heavy clean-clone builds, Rust factory status JSON/lockfile/gc-log/ay-path/local-toolchain/ay-update verification,
...
require_text "docs/RELEASE_READINESS.md" "ay remote \`HEAD\`"
...
require_text "docs/RELEASE_READINESS.md" "\`add_decl_structural_count: 0\`"
require_text "docs/RELEASE_READINESS.md" "\`add_decl_unchecked_count: 0\`"
require_text "docs/RELEASE_READINESS.md" "empty \`files\` list"
...
require_text "docs/RELEASE_READINESS.md" "no matches"
...
require_text "docs/RELEASE_READINESS.md" "structural 0 / unchecked 0"
require_text "docs/RELEASE_READINESS.md" "non-trust release blockers remain fail-closed"
...
require_text "docs/RELEASE_READINESS.md" "./scripts/download_mathverse_library.sh --version=<version> --output-dir=/tmp/mathverse-dl-test"
require_text "docs/RELEASE_READINESS.md" "PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 python3 -m pytest tests/test_download_mathverse_library.py"
...
require_file "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "\`data/unchecked_decl_ratchet.json\`"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "\`add_decl_structural_count: 0\`"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "\`add_decl_unchecked_count: 0\`"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "empty \`files\` list"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "cargo test -p clean-mathverse verify_incremental --lib"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "rg -n \"add_decl_unchecked\" crates/clean-mathverse/src"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "no matches"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "proof-status/provenance/spec-filter alignment"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "cargo test --locked --message-format=short -j 1 -p clean-verify --test proof_status_invariants --test type_preservation_provenance"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "structural 0 / unchecked 0"
require_text "docs/plans/LEAN4_FULL_REPLACEMENT_EXECUTION_PLAN.md" "non-trust release blockers remain fail-closed"
...
require_file "tests/test_download_mathverse_library.py"
...
require_file "docs/VERIFICATION_METRICS.md"
...
require_text "docs/VERIFICATION_METRICS.md" "Sorry-inhabited placeholders"
