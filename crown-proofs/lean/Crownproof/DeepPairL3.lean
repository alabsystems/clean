/-
  ...
  DEEP layer index = 3 (0-based hidden index; layer 0 is the FIRST hidden
  layer, so index 3 is hidden layer #4 -- PAST layer 1).  Pair = (25,34).

  z1,z2 are the TRUE pre-activations of neurons 25,34 at this deep layer.
  ...
  bounds cc1*relu(zU1)+cc2*relu(zU2) <= B, where B = 426.756451 is the max of the
...
theorem acas_deep_25_34_cut
    ...
    (huz1 : z1 ≤ (-38482139 / 268435456 : ℚ)*x0 + (-6887481833 / 268435456 : ℚ)*x1 + (690756447 / 268435456 : ℚ)*x2 + (-118223083 / 268435456 : ℚ)*x3 + (2753934281 / 268435456 : ℚ)*x4 + (91805561654855935766159 / 549755813888000000000 : ℚ))
    (huz2 : z2 ≤ (843005257 / 134217728 : ℚ)*x0 + (17274081345 / 268435456 : ℚ)*x1 + (-1939771469 / 268435456 : ℚ)*x2 + (341820545 / 134217728 : ℚ)*x3 + (-12848488475 / 268435456 : ℚ)*x4 + (29420415933112907160967 / 137438953472000000000 : ℚ)) :
    relu z1 + relu z2 ≤ (234611840213069756538027 / 549755813888000000000 : ℚ) := by
  -- abbreviate the two affine upper bounds
  set zU1 : ℚ := (-38482139 / 268435456 : ℚ)*x0 + (-6887481833 / 268435456 : ℚ)*x1 + (690756447 / 268435456 : ℚ)*x2 + (-118223083 / 268435456 : ℚ)*x3 + (2753934281 / 268435456 : ℚ)*x4 + (91805561654855935766159 / 549755813888000000000 : ℚ) with hzU1
  set zU2 : ℚ := (843005257 / 134217728 : ℚ)*x0 + (17274081345 / 268435456 : ℚ)*x1 + (-1939771469 / 268435456 : ℚ)*x2 + (341820545 / 134217728 : ℚ)*x3 + (-12848488475 / 268435456 : ℚ)*x4 + (29420415933112907160967 / 137438953472000000000 : ℚ) with hzU2
  ...
  have hpp : (1:ℚ) * zU1 + (1:ℚ) * zU2 ≤ (234611840213069756538027 / 549755813888000000000 : ℚ) := by rw [hzU1, hzU2]; linarith [hl0,hu0,hl1,hu1,hl2,hu2,hl3,hu3,hl4,hu4]
  have hpn : (1:ℚ) * zU1 ≤ (234611840213069756538027 / 549755813888000000000 : ℚ) := by rw [hzU1]; linarith [hl0,hu0,hl1,hu1,hl2,hu2,hl3,hu3,hl4,hu4]
  have hnp : (1:ℚ) * zU2 ≤ (234611840213069756538027 / 549755813888000000000 : ℚ) := by rw [hzU2]; linarith [hl0,hu0,hl1,hu1,hl2,hu2,hl3,hu3,hl4,hu4]
  have hnn : (0:ℚ) ≤ (234611840213069756538027 / 549755813888000000000 : ℚ) := by norm_num
  have hcut : (1:ℚ) * relu zU1 + (1:ℚ) * relu zU2 ≤ (234611840213069756538027 / 549755813888000000000 : ℚ) :=
    twoReluCut_pattern_dominance 1 1 zU1 zU2 (234611840213069756538027 / 549755813888000000000 : ℚ) (by norm_num) (by norm_num) hpp hpn hnp hnn
  -- combine monotonicity with the cut bound
  have : relu z1 + relu z2 ≤ relu zU1 + relu zU2 := by linarith
  linarith [hcut]

#print axioms relu_mono
#print axioms acas_deep_25_34_cut
