...
//!
//! This module provides worked examples demonstrating the complete Clean C
...
use crate::auto::VerificationSummary;
...
pub fn print_verification_report() {
    tracing::info!("=======================================================================");
    tracing::info!("                    CLEAN C VERIFICATION EXAMPLES");
    tracing::info!("=======================================================================");
