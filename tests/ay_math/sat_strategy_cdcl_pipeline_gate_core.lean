...
-- Integrated sequential CDCL policy gate for ay SAT-COMP main track. The
-- candidate policy combines branching, phase saving, restart, backtrack, and
-- clause deletion/reduction choices. Adoption is public-result sound only when
-- checker/replay artifacts validate the candidate run.
...
def AySequentialCdclPolicy (policyToken : Prop) :=
  policyToken

def AyBaselineSolverPolicy (policyToken : Prop) :=
  AySequentialCdclPolicy policyToken

def AyCandidateCdclPipelinePolicy
    (branching : Prop) (phaseSaving : Prop) (restart : Prop)
    (backtrack : Prop) (clauseReduction : Prop) :=
  AyConj branching
    (AyConj phaseSaving
...
def AyCdclPipelineGateAccepted
...
def AyCdclPipelineGateRejected
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    (rejected : Prop) :=
  AyConj rejected (AyCdclPipelineDiagnostic timeout noResult mismatch)

def AyCdclPipelineGate
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop)
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    (rejected : Prop) :=
  AyDisj
    (AyCdclPipelineGateAccepted
      candidateFaster retentionOk checkerAccepted replayAccepted
      candidateAccepted)
    (AyCdclPipelineGateRejected timeout noResult mismatch rejected)
...
theorem ay_candidate_cdcl_policy_components
    (branching : Prop) (phaseSaving : Prop) (restart : Prop)
    (backtrack : Prop) (clauseReduction : Prop) :
...
theorem ay_cdcl_pipeline_gate_candidate_faster
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyCdclPipelineGateAccepted
...
theorem ay_cdcl_pipeline_gate_checker_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyCdclPipelineGateAccepted
...
theorem ay_cdcl_pipeline_gate_replay_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyCdclPipelineGateAccepted
...
theorem ay_cdcl_pipeline_gate_retention_evidence
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyCdclPipelineGateAccepted
...
theorem ay_cdcl_pipeline_gate_run_replay
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
    (candidateAccepted : Prop) :
    AyCdclPipelineGateAccepted
...
theorem ay_cdcl_pipeline_public_result_sound
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
  ...
  exact ay_manifest_public_soundness
    ...
    (ay_cdcl_pipeline_gate_run_replay
      candidateFaster retentionOk checkerAccepted replayAccepted
      candidateAccepted gate)

theorem ay_cdcl_pipeline_is_search_only
...
theorem ay_cdcl_pipeline_diagnostic_no_claim
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
    (rejected : Prop) :
    AyCdclPipelineGateRejected timeout noResult mismatch rejected ->
    AyConj
      (AyCdclPipelineDiagnostic timeout noResult mismatch)
      (AyCdclPipelineGateRejected timeout noResult mismatch rejected) := by
  intro rejection
  exact ay_conj_intro
    (AyCdclPipelineDiagnostic timeout noResult mismatch)
    (AyCdclPipelineGateRejected timeout noResult mismatch rejected)
...
theorem ay_cdcl_pipeline_fallback_preserves_baseline
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
...
theorem ay_cdcl_pipeline_rejection_cannot_bless_candidate
    (timeout : Prop) (noResult : Prop) (mismatch : Prop)
...
theorem ay_safe_cdcl_pipeline_sequential_deployment_accept
    (originalFormula : Prop) (visibleFormula : Prop)
    (visibleModel : Prop) (originalModel : Prop) (finalClause : Prop)
    (candidateFaster : Prop) (retentionOk : Prop)
    (checkerAccepted : Prop) (replayAccepted : Prop)
...
theorem ay_safe_cdcl_pipeline_sequential_deployment_fallback
    ...
    AyConj
      (AyPublicSoundnessTheorem originalFormula originalModel)
      (AyCdclPipelineDiagnostic timeout noResult mismatch) := by
  intro rejection
  intro baseline_manifest
  intro baseline_accepted
  exact ay_conj_intro
    (AyPublicSoundnessTheorem originalFormula originalModel)
    (AyCdclPipelineDiagnostic timeout noResult mismatch)
    (ay_cdcl_pipeline_fallback_preserves_baseline
      originalFormula visibleFormula visibleModel originalModel finalClause
