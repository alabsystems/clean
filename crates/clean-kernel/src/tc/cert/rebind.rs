...
fn rebind_binder(cert: ProofCert, fvar_id: FVarId, depth: u32) -> ProofCert {
    ...
    match cert {
        ProofCert::Lam {
            ...
            body_cert: Box::new(convert_fvar_cert_to_bvar(*body_cert, fvar_id, d1)),
        ...
        ProofCert::Pi {
            ...
            arg_type_cert: Box::new(convert_fvar_cert_to_bvar(*arg_type_cert, fvar_id, depth)),
            arg_level,
            body_type_cert: Box::new(convert_fvar_cert_to_bvar(*body_type_cert, fvar_id, d1)),
            body_level,
        },
        ProofCert::Let {
            type_cert,
...
fn rebind_cubical(cert: ProofCert, fvar_id: FVarId, depth: u32) -> ProofCert {
    match cert {
        ...
        ProofCert::CubicalCoe {
            ...
            ty_cert: Box::new(convert_fvar_cert_to_bvar(*ty_cert, fvar_id, depth)),
            r_cert: Box::new(convert_fvar_cert_to_bvar(*r_cert, fvar_id, depth)),
            s_cert: Box::new(convert_fvar_cert_to_bvar(*s_cert, fvar_id, depth)),
            base_cert: Box::new(convert_fvar_cert_to_bvar(*base_cert, fvar_id, depth)),
            result_type: Box::new(result_type.abstract_fvar_at(fvar_id, depth)),
        },
    ...
    match cert {
        ...
        ProofCert::ZFCComprehension {
            ...
            ProofCert::ZFCComprehension {
                ...
                pred_cert: Box::new(convert_fvar_cert_to_bvar(*pred_cert, fvar_id, d1)),
                result_type: Box::new(result_type.abstract_fvar_at(fvar_id, depth)),
            }
        }
...
fn convert_fvar_in_zfc_set_kind(
    ...
    match kind {
        ...
        ZFCSetCertKind::Replacement {
            ...
            ZFCSetCertKind::Replacement {
                set_cert: Box::new(convert_fvar_cert_to_bvar(*set_cert, fvar_id, depth)),
                func_cert: Box::new(convert_fvar_cert_to_bvar(*func_cert, fvar_id, d1)),
            }
        }
