#!/usr/bin/env bash
# G-SIMP — executable fail-closed simp-family tactic gate.
...
# over tests/fixtures/tactic_families/g_simp/*.lean under real `import Init`.
...
exec python3 scripts/tactic_parity/family_gate.py --family g_simp "$@"
