...
//! Polynomial Commitment Schemes for clean Proof Certificates
//!
//! This module (absorbed from the former `clean-commit` crate; rearch
//! stage 9 facade consolidation) provides polynomial commitment schemes
//! (KZG and IPA) for compressing and efficiently verifying clean proof
//! certificates.
//!
//! # Overview
//!
...
//!
//! ```text
//! use clean_fold::commit::{KzgScheme, ProofCommitmentScheme};
...
pub use error::{CommitError, CommitVerifyError, VerifyError};
