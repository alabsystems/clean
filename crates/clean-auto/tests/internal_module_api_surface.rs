...
fn temp_compile_dir(test_name: &str) -> PathBuf {
    ...
    std::env::temp_dir().join(format!(
        "clean_auto_internal_module_api_surface_{test_name}_{}_{}",
        std::process::id(),
        nanos
    ))
}
...
#[test]
#[file_serial]
fn test_egraph_module_is_not_importable_from_external_crate() {
    assert_external_compile_fails(
        "private_egraph_module",
        r#"
#![allow(unused_imports)]
use clean_auto::egraph::EGraph;
"#,
        &["egraph", "private"],
    );
}
...
#[test]
#[file_serial]
fn test_proof_module_is_not_importable_from_external_crate() {
    assert_external_compile_fails(
        "private_proof_module",
        r#"
#![allow(unused_imports)]
use clean_auto::proof::ProofTrace;
"#,
        &["proof", "private"],
    );
}
...
#[test]
#[file_serial]
fn test_superposition_proof_trace_is_not_importable_from_external_crate() {
    assert_external_compile_fails(
        "private_superposition_proof_trace",
        r#"
#![allow(unused_imports)]
use clean_auto::superposition::ProofTrace;
"#,
        &["superposition", "private"],
    );
}

#[test]
#[file_serial]
fn test_superposition_term_is_not_importable_from_external_crate() {
    assert_external_compile_fails(
        "private_superposition_term",
        r#"
#![allow(unused_imports)]
use clean_auto::superposition::Term;
"#,
        &["superposition", "private"],
    );
}
...
#[test]
#[file_serial]
fn test_superposition_substitution_is_not_importable_from_external_crate() {
    assert_external_compile_fails(
        "private_superposition_substitution",
        r#"
#![allow(unused_imports)]
use clean_auto::superposition::Substitution;
"#,
        &["superposition", "private"],
    );
}
...
#[test]
#[file_serial]
fn test_superposition_symbol_is_not_importable_from_external_crate() {
    assert_external_compile_fails(
        "private_superposition_symbol",
        r#"
#![allow(unused_imports)]
use clean_auto::superposition::Symbol;
"#,
        &["superposition", "private"],
    );
}
