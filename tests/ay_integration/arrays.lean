/-
  Ay Integration Tests: Array Theory (QF_AUFLIA)

  Tests the ay_smt tactic with arrays combined with linear arithmetic.
-/
...
theorem array_ext (a b : Array Int Int) :
  ...
  ay_smt (logic := "AUFLIA")  -- Requires quantifiers
